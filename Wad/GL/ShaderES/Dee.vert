#version 300 es
// WebGL2 replacement for Dee.vert + Dee.geom: a pixel-space 'D' shape (a rectangle with
// only one side's corners rounded), expanded into a quad per instance (see Rect.vert).
// Attributes:
