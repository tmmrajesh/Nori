#version 300 es
// WebGL2 replacement for RRectBorder.vert + RRectBorder.geom: a pixel-space rounded
// rectangle with a border, expanded into a quad per instance (see Rect.vert for notes).
// Attributes:
